...
export const manualMaintainedData: RootItem[] = [
  ...
  { name: '高程编程作业提交', url: 'http://192.168.174.220/', alias: '高级语言程序设计 沈坚' },
  { name: '高程文档作业提交', url: 'http://192.168.174.220:2080/', alias: '高级语言程序设计 沈坚' },
  {
    name: '高程课程文档网站',
    url: 'https://tongji-high-level-language-programming.github.io/Website/',
    alias: '高级语言程序设计 沈坚',
  },
